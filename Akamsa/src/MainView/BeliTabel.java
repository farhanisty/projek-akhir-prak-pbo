 ...
 * @author ASUS
 */
public class BeliTabel extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BeliTabel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
